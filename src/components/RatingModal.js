...
const styles = StyleSheet.create({
    ...
    handle: { width: 48, height: 5, borderRadius: 2.5, backgroundColor: '#E5E7EB', marginBottom: 20 },
    closeBtn: { position: 'absolute', top: 24, right: 24, backgroundColor: '#F3F4F6', padding: 8, borderRadius: 20 },

    emoji: { fontSize: 48, marginBottom: 8 },
    title: { fontSize: 24, fontWeight: '900', color: '#111827', marginBottom: 6, letterSpacing: -0.5 },
